...
using System.Text;
using efcoremongodb.Dtos.AccountDto;
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        private async Task<LoginResponse> LoginAsync(LoginRequest request)
        {
            try
            {
                ...
                var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("gfdfgsdlfjsdoljfsdlkgklgjdflgjlfdkgdfhhgfhfghdgfhyrfdfdasdsadas"));
